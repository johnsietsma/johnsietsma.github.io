...
{% include shaders/flowDirectionFrag.html %}
{% include shaders/flowMapTimeCycleFrag.html %}
{% include shaders/flowMapFrag.html %}
...
function initCanvas_FlowDirection( threeContext )
{
    ...
    initFullScreenCanvas( threeContext, 'defaultVert', 'flowDirectionFrag' );
}
...
function initCanvas_FlowMapTimeCycle( threeContext )
{
    ...
    initFullScreenCanvas( threeContext, 'defaultVert', 'flowMapTimeCycleFrag' );
}
...
function initCanvas_FlowMap( threeContext )
{
    ...
    initFullScreenCanvas( threeContext, 'defaultVert', 'flowMapFrag' );
}
...
OpenGL ES 2.0 doesn't have a ```mod``` function, so here is how I calculate the time cycle:
