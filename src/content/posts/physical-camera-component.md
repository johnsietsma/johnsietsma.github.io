...
pubDatetime: 2020-07-20T00:00:00+10:00
description: "Unity HDRP has a physical section on it's camera component. It mimics real-life camera settings like sensor, size, ISO, focal length and aperture. These..."
tags:
  - unity
  - hdrp
  - camera
...
[![Physical Camera Control](/assets/images/physical_camera/PhysicalCameraControlComponent.PNG)](https://github.com/johnsietsma/PhysicalCameraControl)
...
![Wide Shot](/assets/images/physical_camera/close2.PNG){:height="40%" width="40%"}

Narrow shot:

![Narrow Shot](/assets/images/physical_camera/narrow1.PNG){:height="40%" width="40%"}

Dolly Zoom:

![Dolly Zoom](/assets/images/physical_camera/DollyZoom.gif){:height="40%" width="40%"}

Lock Exposure - Change F/Stop for Depth of Field effect without ruining exposure:

![Lock Exposure](/assets/images/physical_camera/LockExposure.gif){:height="40%" width="40%"}
