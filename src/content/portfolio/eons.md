...
<div class="text-center screen-shot">
    <div class="row neg-margin">
        <div class="col-md-6">
            <img src="/assets/images/eons/screen1.png" alt="Eons screen shot"/>
        </div>
        <div class="col-md-6">
            <img src="/assets/images/eons/screen2.png" alt="Eons screen shot"/>
        </div>
        <div class="col-md-6">
            <img src="/assets/images/eons/screen3.png" alt="Eons screen shot"/>
        </div>
    </div>
</div>
