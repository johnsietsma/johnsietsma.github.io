...
![Dolly Zoom](/assets/images/physical_camera/DollyZoom.gif){:height="60%" width="60%"}

Lock Exposure - Change F/Stop for Depth of Field effect without ruining exposure:

![Lock Exposure](/assets/images/physical_camera/LockExposure.gif){:height="60%" width="60%"}

Wide shot:

![Wide Shot](/assets/images/physical_camera/close2.PNG){:height="60%" width="60%"}

Narrow shot:

![Narrow Shot](/assets/images/physical_camera/narrow1.PNG){:height="60%" width="60%"}
