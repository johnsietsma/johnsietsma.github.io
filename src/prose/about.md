...
Clayton Sparke and John Sietsma.
*An Update on Evaluating Sound Pressure Levels of Noise Sources in Busy Noise Environments
with Deep Learning.* Proceedings of INTER-NOISE 2026, Adelaide, August 2026.

## Patent applications

- *Designating Real World Locations for Virtual World Control.* US 20130215109, filed
  February 2013. Silka Miesnieks, John Sietsma.
- *Augmented Reality System Using a Portable Device.* US 20130215230, filed February 2013.
  Miesnieks, Miesnieks, Baillot, Gardeya, Naimark, Maes, Sietsma.

## Elsewhere

- [GitHub](https://github.com/johnsietsma): open source projects, including
  [ExtendingLWRP](https://github.com/johnsietsma/ExtendingLWRP) and
  [ARCameraLighting](https://github.com/johnsietsma/ARCameraLighting)
- [Sketchfab](https://sketchfab.com/john.sietsma/models): photogrammetry captures of
  street art, murals and industrial heritage
- [Talks on YouTube](https://www.youtube.com/results?search_query=john+sietsma+unity),
  including [Extending the Lightweight Render Pipeline](https://youtu.be/fUY8bbNbX5k)
  from Unite and [Mobile AR Design: From Start to Finish](https://youtu.be/skMim823U5s)
  from AWE
- [LinkedIn](https://www.linkedin.com/in/jsietsma/)
